 ...
 */
@Controller
@RequestMapping("/Stud/NotasTareas")
public class NotasTareaStudentController {
    ...
    public String save(@ModelAttribute Notastareas user){
        ...
        return "redirect:/Stud/NotasTareas/listar";
    }
