 ...
 */
@Controller
@RequestMapping("/Repre/Matriculacion")
public class MatriculacionController {
    ...
    public String page(Model model) {
        ...
        return "/Representante/Matriculacionlist";
    }
    ...
    private String crear(Model model){
        ...
        return "/Representante/MatriculacionAdd";
    }
    @PostMapping("/save")
    public String save(@ModelAttribute Matriculacion user){
        ...
        return "redirect:/Repre/Matriculacion/listar";
    }
